...
import { r as isApiError } from "./_ssr/client-oeguNz2X.mjs";
...
import { n as usersService } from "./_ssr/dashboard.service-BG5nlFS2.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_admin.users-BiZl6-X-.js
...
function UsersPage() {
	...
	const [toSuspend, setToSuspend] = (0, import_react.useState)(null);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Box, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ConfirmDialog, {
			...
			onConfirm: () => {
				if (toSuspend) suspend.mutate(toSuspend.id, { onSuccess: () => {
					setToSuspend(null);
					setDetail(null);
				} });
			}
