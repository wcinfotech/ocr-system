...
//#region node_modules/.nitro/vite/services/ssr/assets/client-oeguNz2X.js
/**
...
var apiBaseUrl = "https://ocr-system-production-a9e4.up.railway.app/api/v1";
if (apiBaseUrl && !apiBaseUrl.startsWith("http://") && !apiBaseUrl.startsWith("https://")) apiBaseUrl = `https://${apiBaseUrl}`;
var env = {
	...
	*/
	...
	APP_NAME: "Admin Panel (Production)",
	/** localStorage keys */
