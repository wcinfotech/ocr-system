...
import { n as env, t as apiClient } from "./_ssr/client-oeguNz2X.mjs";
import { n as zt } from "./_libs/react-hot-toast.mjs";
import { i as useQueryClient, n as useQuery, t as useMutation } from "./_libs/tanstack__react-query.mjs";
import { t as PageHeader } from "./_ssr/PageHeader-9ov710wi.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_admin.blogs-B2O5GdC6.js
...
function BlogsPage() {
	...
	const getBlogImageUrl = (url) => {
		...
		if (url.startsWith("http://") || url.startsWith("https://")) {
			if (url.includes("/api/v1/uploads/")) return url.replace("/api/v1/uploads/", "/uploads/");
			return url;
		}
		return `${env.API_BASE_URL.replace(/\/api\/v1\/?$/, "").replace(/\/api\/?$/, "")}${url}`;
	};
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Box, { children: [
									...
									featuredImage ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Box, {
										...
										onDragLeave: (e) => {
											e.preventDefault();
											e.stopPropagation();
											if (!e.currentTarget.contains(e.relatedTarget)) setImageDragActive(false);
										},
										onDragOver: (e) => {
											e.preventDefault();
											e.stopPropagation();
